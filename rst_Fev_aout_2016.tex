...
\section{LLRP}
% descibe everthing you did in LLRP
\section{SmartFlah}
...
Cette conception UHF de tag est constitué d'une antenne de boucle circulaire avec un réseau d'adaptation à deux éléments pour faire correspondre les impédances de l'antenne de l'étiquette et l'étiquette puce. Des mesures plus détaillées de conception de cette balise peut être trouvée dans \cite{related} . Cependant, l'étiquette a été rendue légèrement plus grand diamètre par rapport à celui présenté dans \cite{related} en fonction de l'application étudiée. 
...
La figure 3.11 présente des caractéristiques de changement de fréquence de résonance lorsqu'un \emph{short stubs} est mis en œuvre à l'intérieur de la boucle de l'antenne. La longueur du tronçon est de 20 mm et la fréquence de résonance chute 30MHz (3,3\%) à partir de 911.25MHz à 881.25MHz lorsque l'écart de la ligne de la fusée est 2mm. En effet, le courant est distribué le long du talon et de la longueur totale de la boucle est augmentée à 13\%. En outre, non seulement les capacitances sont augmentées par la dilatation de la longueur de la boucle, mais aussi les inductances sont augmentées par la structure\\\\\\\\\\\\\\\\\\\\\\\\\ de \emph{short stubs}. Par conséquent, l'impédance de l'antenne permet une adaptation d'impédance que la longueur de boucle est supérieure à une longueur d'onde,de sorte que la fréquence est éventuellement diminuée. Si elle est résonant à la même fréquence, le diamètre total de la boucle devient plus petit, de sorte que l'antenne cadre est miniaturisé par les bouts joints.


\begin{figure}[h!]
\centering
\includegraphics[width=6cm]{stuba}
\includegraphics[width=6cm]{stubb}
\caption{CLA - S11}
\end{figure}
...
Au moyen d'un procédé de miniaturiser une antenne en boucle, deux types d'antennes sont conçues. Fig. 8, une antenne est miniaturisé avec les deux ergots courtes de 11,5 mm et 7 mm situés dans la boucle alternant les uns avec les autres. La largeur de la ligne est de 0.3mm et l'intervalle entre les lignes est de 0.3mm. Il est adapté à la longueur et l'intervalle d'une ligne d'alimentation série axée sur ce qui est de 8mm et 1mm. Le diamètre d'une antenne est miniaturisé à 40 mm en termes de maximisation d'un chemin de courant inséré avec des talons doubles. La longueur totale d'une antenne est de 3,9 (1281mm)\\
\begin{figure}[h!]
\centering
...
Dans cet article, de faire une antenne de petite taille d'étiquette RFID dans la bande UHF, le CLA est proposé. Afin de faire correspondre l'impédance du CLA, l'intervalle et la durée entre l'alimentation en série entraînée sont modulés lorsque l'alimentation en série entraînée est situé à l'intérieur de la boucle. En outre, il est proposé d'augmenter la longueur de courant par un court tronçon situé à l'intérieur de la boucle. Grâce à ce résultat, nous pouvons confirmer que CLAS de type miniaturisés utilisant des talons courts sont adaptés pour miniaturisés antennes RFID tag avec la bande UHF.\\


Une autre methode a etait concu apres des expeience de \emph{Reverse Engineering} des tag UHF recu de l'etranger. cette methode consiste a boucle l'antenne en interne de tell sorte a minimiser le diamettre sans changer la longeur les deux pole. la figure suivante presente le resulatat du  \emph{X-RAY Reverse engineering} qui permet de voire en interne sans massacre la piece. 
...
\end{figure}
comme le montre la figure 3.15 la taille a était énormément améliorer et le performance de cette antenne gardant les même. cette structure nous a permit un contrôle de fréquence bien régis. toute variation de longueur de 2mm nous donne un décalage de fréquence de 10MHz et un gain d'environ . la figure suivante montre cette... plus de détail sur la simulation seront présenter dans le chapitre suivant.
...
la troisieme etape  consiste a realiser l'entenne de la figure x. un antenne qui rayone dans la frequence 915MHz. l'experience montre que sa distance de lecture est de 2m.\\

\begin{figure}[h!]
\centering
\includegraphics[width=6cm]{front11}
\includegraphics[width=6cm]{back22}
\caption{S11du tag UHF améliorer }
\end{figure}

plus de détail sur la simulation seront présenter dans le chapitre suivant.
...
\subsubsection{CST studio}

\section{Réalisation	du	projet}
\subsection{Antenne UHF}
Dans cette section je vais présenter les différentes résultats et simulation sur les antennes RFID UHF. La puce utiliser est la H3 de Alien. Le logiciel de simulation est CST studio 2014 qui permet de calculer un grand nombre de paramètre d'antenne.
\subsubsection{Le premier prototype UHF}

\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{1ST}
\caption{Illustration du systÃ¨me RFID}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{vswr}
\caption{Illustration du systÃ¨me RFID}
\end{figure}
...
Mun Leng Ng, Member, IEEE, Kin Seong Leong, David M Hal, Peter H.Cole 
Department of Electrical and Electronic Engineering, Auto-IDLabs, University of Adelaide
(mng,kleong,dhal,cole)@Jeleceng.adelaide.edu.au
